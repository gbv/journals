...
<!-- review -->
          <xsl:if test="div[@id='mir-review']">
            <div class="panel panel-default">
              <div class="panel-heading">
                <h3 class="panel-title"><xsl:value-of select="i18n:translate('metaData.review')" /></h3>
              </div>
              <div class="panel-body">
                <xsl:apply-templates select="div[@id='mir-review']" mode="copyContent" />
              </div>
            </div>
          </xsl:if>
<!-- system -->
